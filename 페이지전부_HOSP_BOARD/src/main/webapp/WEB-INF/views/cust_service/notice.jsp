...
<input type="hidden" name="goalPage" value="notice_list.do" />
...
<style type='text/css'>
	.write_button { BACKGROUND-COLOR: #35B0D9;color: white ;padding:4 4 4 4;width:44px;border:0;height:25px;font-size:10pt;cursor:pointer; }	
	.new { BACKGROUND-COLOR: #FE8004;color: white ;padding:4 4 4 4;width:27px;border:0;height:15px;font-size:8pt; }	
</style>
...
<div class="centerv_right_top">
	<div class="centerv_right_top_tit1">
		...
		<span>고객지원</span>
		&gt;
		<span class="spaor">공지사항</span>
	</div>
	<div class="centerv_right_top_tit2">공지사항</div>
	<div class="centerv_right_top_tit3">NOTICE</div>
</div>
...
<div class="centerv_right_labelv">
	<table style="width:100%;border-spacing:0;border-collapse:collapse;" class="bom_label">
		...
		<thead>							
		 ...
		 <tr>
		<td height="30px" colspan="3" align="center">공지사항이 없습니다.</td>
	  </tr>
	  <tr>
						<td colspan="3" height="1px" background="/images/button/bg_dot.gif"></td>
					</tr>
		...
		<tr class="backybll">
			<td height="25px" colspan="3" bgcolor="#BBDCAA" class="noborle">
		<!--  -->
