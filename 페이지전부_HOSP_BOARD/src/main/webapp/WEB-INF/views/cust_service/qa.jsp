...
<input type="hidden" name="goalPage" value="qna_list.do" />
...
<style type='text/css'>
	.qnabutton { BACKGROUND-COLOR: #A1D935;color: white ;padding:4 4 4 4;width:44px;border:0;height:25px;font-size:10pt;cursor:pointer; }	
	.qnanew { BACKGROUND-COLOR: #FE8004;color: white ;padding:4 4 4 4;width:27px;border:0;height:15px;font-size:8pt; }	
</style>


<form name="board_frm" method="post">
<input type="hidden" name="qna_num" />
<input type="hidden" name="page_c" value="1" />
...
<div class="centerv_right_top">
	<div class="centerv_right_top_tit1">
		...
		<span>고객지원</span>
		&gt;
		<span class="spaor">Q&amp;A</span>
	</div>
	<div class="centerv_right_top_tit2">Q&amp;A</div>
	<div class="centerv_right_top_tit3">QUESTION &amp; ANSWER</div>
</div>

<div class="centerv_right_labelv">

			<div class="han_sub18t">
				<p>※ 가족구성원 추가는 개인정보수정에서 실명확인후 하단에 가족을 추가할수 있습니다.</p>
				<p>※ 가족구성원 추가하신후 '수정완료' 버튼을 눌러주세요. </p>
				<p>※ 개명요청시 로그인하시거나 ID를 남겨주셔야 변경가능합니다. </p>
			</div>

			<div class="han_table_head">
				<div class="han_table_head_lf">
					<span><input type="button" value="new" class="qnanew" />&nbsp;:&nbsp;새로운 글&nbsp;</span>
					<span>
						<label for="han_check01">
							<input type="checkbox" checked="checked" id="han_check01" disabled />
						</label>&nbsp;:&nbsp;답변이 있는 글
					</span>
					<span><img src="/images/icon/icon_lock.gif" alt="" />&nbsp;:&nbsp;비밀글&nbsp;</span>
				</div>
				<div class="han_table_head_rt">
					<input type="button" class="qnabutton" value="글쓰기" onclick="qna_write()" />
				</div>
				<div class="clear"></div>
			</div>
			...
			<div class="han_board">
				<table style="width:100%;border-spacing:0;border-collapse:collapse;" class="bom_label">
					...
					<tbody>
						<tr class="backyfa borbom bbb_mmm">
							<th>번호</th>
							<th>답글</th>
							<th>제목</th>
							<th>작성자</th>
					...
					<tr class="backyfa borbom bbb_mmm">
						...
						<td>
							  ...
							  <input type="checkbox" checked="checked" id="han_check02" disabled />
							
						</td>
						<td style="width:54%">&nbsp;
														  
							  <input type="button" value="new" class="qnanew" />
							
							
							
							  <img src="/images/icon/icon_lock.gif" border="0" align="absmiddle" />
							
							  <a href="#" onClick="qna_view('7442', '0', 'T')">불이행처리</a>
					...
					<tr class="backyfa borbom bbb_mmm">
						...
						<td style="width:54%">&nbsp;
							  ...
							  <a href="#" onClick="qna_view('7439', '0', 'T')">개명 요청</a>
					...
					<tr class="backyfa borbom bbb_mmm">
						...
						<td style="width:54%">&nbsp;
							  ...
							  <a href="#" onClick="qna_view('7438', '0', 'T')">개명 요청</a>
					...
					<tr class="backyfa borbom bbb_mmm">
						...
						<td style="width:54%">&nbsp;
							  ...
							  <a href="#" onClick="qna_view('7436', '0', 'T')">개명 요청</a>
					...
					<tr class="backyfa borbom bbb_mmm">
						...
						<td style="width:54%">&nbsp;
							  ...
							  <a href="#" onClick="qna_view('7434', '0', 'T')">개명 요청</a>
					...
					<tr class="backyfa borbom bbb_mmm">
						...
						<td style="width:54%">&nbsp;
							  ...
							  <a href="#" onClick="qna_view('7432', '0', 'T')">예약 수정을 했는데</a>
					...
					<tr class="backyfa borbom bbb_mmm">
						...
						<td style="width:54%">&nbsp;
							  ...
							  <a href="#" onClick="qna_view('7430', '0', 'T')">불이행건수</a>
					...
					<tr class="backyfa borbom bbb_mmm">
						...
						<td style="width:54%">&nbsp;
							  ...
							  <a href="#" onClick="qna_view('7428', '0', 'T')">병원에 갔었는데요</a>
					...
					<tr class="backyfa borbom bbb_mmm">
						...
						<td style="width:54%">&nbsp;
							  ...
							  <a href="#" onClick="qna_view('7426', '0', 'T')">예약불이행 처리로 인한 예약 불가 관련</a>
					...
					<tr class="backyfa borbom bbb_mmm">
						...
						<td style="width:54%">&nbsp;
							  ...
							  <a href="#" onClick="qna_view('7424', '0', 'T')">예약불이행 건.</a>
...
<div class="han_btn_table_foot">	
		...
		<a href="#" onclick="link_page('5')">5</a>&nbsp;
	  
		<a href="#" onclick="link_page('6')">6</a>&nbsp;
	  
		<a href="#" onclick="link_page('7')">7</a>&nbsp;
	  
		<a href="#" onclick="link_page('8')">8</a>&nbsp;
	  
		<a href="#" onclick="link_page('9')">9</a>&nbsp;
	  
		<a href="#" onclick="link_page('10')">10</a>&nbsp;
	  
		<a href="#" onclick="link_page('11')">▶</a>
	  			  
	  <input type="hidden" name="page" value="10">			 
</div>
 <!-- %//=========================================== 페이징 처리 ============================ e %> -->

<div class="han_label_center">
	<label for="keyField">
		...
		<script>document.board_frm.keyField.value='name';</script>

	</label>
	<label for="han_inp01">
		<input type="text" size="16" name="keyWord" valign="top" value="" onKeyDown="enter(this.value)" />
	</label>					
	<input type="button" class="qnabutton" value="검색" onclick="qna_search_check()" />
</div>
