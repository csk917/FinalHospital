...
<input type="hidden" name="goalPage" value="evalue_guide.do" />
...
<style type='text/css'>
	.button { BACKGROUND-COLOR: #35B0D9;color: white ;padding:4 4 4 4;width:164px;border:0;height:30px;font-size:13pt;cursor:pointer;font-weight:bold; }	
	.whght{height:149px;width:676px;}
</style>
...
<div class="centerv_right_top">
	<div class="centerv_right_top_tit1">
		...
		<span>만족도조사</span>
		&gt;
		<span class="spaor">만족도조사 가이드</span>
	</div>
	<div class="centerv_right_top_tit2">만족도조사가이드</div>
	<div class="centerv_right_top_tit3">PARTICIPATION GUIDE</div>
</div>

<div class="lyjmi_centerv_right_bom">
	<div class="lyjmi_centerv_right_bom_titilev margin_bom15">만족도조사에 참여하는 방법입니다.</div>
	<div class="lyjjyo_sub12_borblue"><img src="../images/main/sub12_01.gif" alt="" /></div>
	<div class="lyjjyo_sub12_center">
		<p>(1) 메뉴의 <span class="red">만족도조사 참여</span>를 클릭합니다.</p>
		<p>※ 만족도조사 참여의 오른쪽 숫자는 참여가 가능한 만족도조사의 갯수입니다.</p>
		<p>(2)	로그인을 하셨다면 만족도조사 화면이, 로그인을 하지 않으셨다면 다음의 화면이 나옵니다.</p>
	</div>
	<div class="lyjjyo_sub12_borblue"><img src="../images/main/sub12_02.gif" alt="" /></div>
	<div class="lyjjyo_sub12_center">
		<p>(1) 로그인을 하지 않았다면 아이디/비밀번호를 입력하고 LOGIN 버튼을 클릭하면 만족도조사 참여 리스트가 나옵니다.</p>		
	</div>
	 <div class="lyjjyo_sub12_borblue whght"><img src="../images/main/sub12_02-1.gif" alt="" /></div>
	 <div class="lyjjyo_sub12_center">
		<p>(1)	참여하고자 하는 병원의 만족도조사 버튼을 클릭합니다.</p>
		<p>※ 클릭하면 다음과 같은 화면이 나옵니다.</p>
	</div>
	<div class="lyjjyo_sub12_borblue"><img src="../images/main/sub12_03.gif" alt="" /></div>
	<div class="lyjjyo_sub12_center">		
		<p>※ 각각의 질문에 대한 별을 선택하신후 만족도 조사 완료 버튼 클릭하시면 만족도조사가 완료됩니다.</p>
	</div>
	<div class="lyj_sub12_abottom"><input type="button" class="button" value="만족도조사 참여하기" onclick="javascript:location.href='evalue.do'" /></div>
</div>
			</div>
