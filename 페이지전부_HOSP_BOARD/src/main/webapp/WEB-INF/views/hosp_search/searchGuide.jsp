...
<input type="hidden" name="goalPage" value="search_guide.do" />
...
<div class="centerv_right">
	<div class="centerv_right_top">
		<div class="centerv_right_top_tit1">
			...
			<span>병원검색</span>
			&gt;
			<span class="spaor">병원검색 가이드</span>
		</div>
		<div class="centerv_right_top_tit2">검색가이드</div>
		<div class="centerv_right_top_tit3">HOSPITAL SEARCH GUIDE</div>
	</div>
</div>

<div class="margin_bom20">
	<a href="#" class="width120"></a>
</div>
<div class="lyjmi_centerv_right_bom_titilev margin_bom15">모든 병원에 대해서 검색이 가능합니다.</div>
<div class="lyjjyo_sub12_borblue"><img src="../images/main/sub8_1_xg1.png" alt="" /></div>
<div class="lyjjyo_sub12_center">
	<p> (1) 병원의 진료과목을 선택합니다.(ex> 전체,내과,소아청소년과 등) </p>
	<p> (2) 검색할 병원이름을 입력합니다.</p>
	<p>※ 아무것도 입력하지 않으면 모든 병원이 검색됩니다.</p>
	<p> (3) 검색버튼을 클릭하면 검색이 시작됩니다.</p>
	<p> (4) 직접 지도를 보고 병원을 찾을 수 있습니다.</p>
</div>
<div class="lyjjyo_sub12_borblue"><img src="../images/main/sub8_1_xg3.png" alt="" /></div>
<div class="lyjjyo_sub12_center">
    <p> (1) 병원의 이름을 클릭하면 해당 병원의 상세정보를 볼 수 있습니다.</p>
	<p> (2) 예약 버튼을 클릭하면 해당 병원에 예약 하실 수 있습니다.</p>
	<p>※ 버튼이 안 보인다면 서비스를 이용하지 않는 병원입니다.</p>
</div>
<div class="lyjjyo_sub12_borblue"><img src="../images/main/sub8_1_xg4.png" alt="" /></div>
<div class="lyjjyo_sub12_center">
	<p> (1) 병원의 상세정보 보기에서도 예약 버튼을 클릭하면 해당 병원에 예약을 하실 수 있습니다.</p>
	<p> (2) 만족도조사 버튼을 클릭하면 해당 병원에 만족도조사를 하실 수 있습니다.</p>
	<p>※ 버튼이 안 보인다면 서비스를 이용하지 않는 병원입니다.</p>
</div>
