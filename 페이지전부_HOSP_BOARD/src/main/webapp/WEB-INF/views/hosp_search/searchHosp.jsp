...
<input type="hidden" name="goalPage" value="host_search.do" />
...
<input type="hidden" name="viewTitle" value="전체병원검색">
...
<div class="centerv_right_top">
	<div class="centerv_right_top_tit1">
		...
		<span>병원검색</span>
		&gt;
		<span class="spaor">전체병원검색</span>
	</div>
	<div class="centerv_right_top_tit2">전체병원검색</div>
	...
	<div class="centerv_right_three_bom" >
		<table width="100%" border="0" align="center" cellpadding="0" cellspacing="3">
			...
			<tr>
					...
					<td width="20%" >
					<a href="javascript:;" onclick="LocationSearch('서울특별시')">서울특별시(14812)</a>
					</td>
					
					<td width="20%" >
					<a href="javascript:;" onclick="LocationSearch('경기도')">경기도(11443)</a>
					</td>
					
					<td width="20%" >
					<a href="javascript:;" onclick="LocationSearch('인천광역시')">인천광역시(2640)</a>
					</td>
					
					<td width="20%" >
					<a href="javascript:;" onclick="LocationSearch('강원도')">강원도(1432)</a>
					</td>
					
					<td width="20%" >
					<a href="javascript:;" onclick="LocationSearch('충청남도')">충청남도(2125)</a>
					</td>
			...
			<tr>
					...
					<td width="20%" >
					<a href="javascript:;" onclick="LocationSearch('대전광역시')">대전광역시(2138)</a>
					</td>
					
					<td width="20%" >
					<a href="javascript:;" onclick="LocationSearch('충청북도')">충청북도(1582)</a>
					</td>
					
					<td width="20%" >
					<a href="javascript:;" onclick="LocationSearch('세종특별자치시')">세종특별자치시(23)</a>
					</td>
					
					<td width="20%" >
					<a href="javascript:;" onclick="LocationSearch('부산광역시')">부산광역시(4524)</a>
					</td>
					
					<td width="20%" >
					<a href="javascript:;" onclick="LocationSearch('울산광역시')">울산광역시(1184)</a>
					</td>
			...
			<tr>
					...
					<td width="20%" >
					<a href="javascript:;" onclick="LocationSearch('대구광역시')">대구광역시(3286)</a>
					</td>
					
					<td width="20%" >
					<a href="javascript:;" onclick="LocationSearch('경상북도')">경상북도(2519)</a>
					</td>
					
					<td width="20%" >
					<a href="javascript:;" onclick="LocationSearch('경상남도')">경상남도(3192)</a>
					</td>
					
					<td width="20%" >
					<a href="javascript:;" onclick="LocationSearch('전라남도')">전라남도(1750)</a>
					</td>
					
					<td width="20%" >
					<a href="javascript:;" onclick="LocationSearch('광주광역시')">광주광역시(1823)</a>
					</td>
			...
			<tr>
					...
					<td width="20%" >
					<a href="javascript:;" onclick="LocationSearch('전라북도')">전라북도(2209)</a>
					</td>
					
					<td width="20%" >
					<a href="javascript:;" onclick="LocationSearch('제주특별자치도')">제주특별자치도(617)</a>
					</td>
